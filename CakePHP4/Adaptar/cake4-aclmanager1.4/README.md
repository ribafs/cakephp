...
composer create-project --prefer-dist cakephp/app:~4.0 acl
...
```
composer require ribafs/cake4-aclmanager
bin/cake plugin load AclManager
```
Install and load migrations
```
