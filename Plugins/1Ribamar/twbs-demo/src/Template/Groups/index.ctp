        ...
        <?php foreach ($groups as $group): ?>
            <tr>
                ...
                <td><?= h($group->modified) ?></td>
                    <td class="actions">
                    <?= $this->Html->link('<span class="glyphicon glyphicon-zoom-in"></span><span class="sr-only">' . __('Visializar') . '</span>', ['action' => 'view', $group->id], ['escape' => false, 'class' => 'btn btn-xs btn-default', 'title' => __('Visualizar')]) ?>
                    ...
                    <?= $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span><span class="sr-only">' . __('Excluir') . '</span>', ['action' => 'delete', $group->id], ['confirm' => __('Excluir realmente o registro # {0}?', $group->id), 'escape' => false, 'class' => 'btn btn-xs btn-danger', 'title' => __('Excluir')]) ?>
                </td>
            </tr>
