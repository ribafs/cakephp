...
/*
		...
		$controllers = $conn->execute("select distinct(controller) from permissions")->fetchAll();
		$this->set('controllers', $controllers);
*/

		// Plugin TBS
		$this->set('project_name', 'Esqueleto de Aplicativo');
...
//		$this->Auth->allow(['index','add','edit']);
		...
		if(isset($group)){
			...
			// Cadastrar todos as permissões sobre Clientes para os usuários do grupo Managers
